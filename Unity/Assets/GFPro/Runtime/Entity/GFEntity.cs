...
namespace GFPro
{
    ...
    /// 实体。
    /// </summary>
    public sealed class GFEntity : MonoBehaviour, IEntity
    {
        private int          m_Id;
        ...
        public void OnInit(int entityId, string entityAssetName, IEntityGroup entityGroup, bool isNewInstance, object userData)
        {
            ...
            if (m_EntityLogic == null)
            {
                Log.Error("Entity '{0}' can not add entity logic.".Fmt(entityAssetName));
                return;
            }
            ...
            {
                Log.Error("Entity '[{0}]{1}' OnInit with exception '{2}'.".Fmt(m_Id, m_EntityAssetName, exception));
            }
        }
        ...
        public void OnRecycle()
        {
            ...
            {
                Log.Error("Entity '[{0}]{1}' OnRecycle with exception '{2}'.".Fmt(m_Id, m_EntityAssetName, exception));
            }
        ...
        public void OnShow(object userData)
        {
            ...
            {
                Log.Error("Entity '[{0}]{1}' OnShow with exception '{2}'.".Fmt(m_Id, m_EntityAssetName, exception));
            }
        }
        ...
        public void OnHide(bool isShutdown, object userData)
        {
            ...
            {
                Log.Error("Entity '[{0}]{1}' OnHide with exception '{2}'.".Fmt(m_Id, m_EntityAssetName, exception));
            }
        }
        ...
        public void OnAttached(IEntity childEntity, object userData)
        {
            ...
            try
            {
                m_EntityLogic.OnAttached(((GFEntity)childEntity).Logic, attachEntityInfo.ParentTransform, attachEntityInfo.UserData);
            }
            catch (Exception exception)
            {
                Log.Error("Entity '[{0}]{1}' OnAttached with exception '{2}'.".Fmt(m_Id, m_EntityAssetName, exception));
            }
        }
        ...
        public void OnDetached(IEntity childEntity, object userData)
        {
            try
            {
                m_EntityLogic.OnDetached(((GFEntity)childEntity).Logic, userData);
            }
            catch (Exception exception)
            {
                Log.Error("Entity '[{0}]{1}' OnDetached with exception '{2}'.".Fmt(m_Id, m_EntityAssetName, exception));
            }
        }
        ...
        public void OnAttachTo(IEntity parentEntity, object userData)
        {
            ...
            try
            {
                m_EntityLogic.OnAttachTo(((GFEntity)parentEntity).Logic, attachEntityInfo.ParentTransform, attachEntityInfo.UserData);
            }
            catch (Exception exception)
            {
                Log.Error("Entity '[{0}]{1}' OnAttachTo with exception '{2}'.".Fmt(m_Id, m_EntityAssetName, exception));
            }
        ...
        public void OnDetachFrom(IEntity parentEntity, object userData)
        {
            try
            {
                m_EntityLogic.OnDetachFrom(((GFEntity)parentEntity).Logic, userData);
            }
            catch (Exception exception)
            {
                Log.Error("Entity '[{0}]{1}' OnDetachFrom with exception '{2}'.".Fmt(m_Id, m_EntityAssetName, exception));
            }
        }
        ...
        public void OnUpdate(float elapseSeconds, float realElapseSeconds)
        {
            ...
            {
                Log.Error("Entity '[{0}]{1}' OnUpdate with exception '{2}'.".Fmt(m_Id, m_EntityAssetName, exception));
            }
        }
    }
}