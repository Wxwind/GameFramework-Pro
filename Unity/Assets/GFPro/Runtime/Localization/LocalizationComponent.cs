...
namespace GFPro
{
    ...
    /// 本地化组件。
    /// </summary>
    public sealed class LocalizationComponent : Singleton<LocalizationComponent>, ISingletonAwake
    {
        ...
        public void Awake()
        {
            ...
            m_LocalizationManager.SetResourceManager(ResourceComponent.Instance);
