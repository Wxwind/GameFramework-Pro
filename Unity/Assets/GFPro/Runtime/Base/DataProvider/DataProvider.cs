...
namespace GFPro
{
    ...
    internal sealed class DataProvider<T> : IDataProvider
    {
        ...
        public async UniTask ReadData(string dataAssetName)
        {
            ...
            {
                throw new GameFrameworkException($"Load data failure in data provider helper, data asset name '{dataAssetName}'.", exception);
            }
            finally
            {
        ...
        public void ParseData(byte[] dataBytes, int startIndex, int length)
        {
            ...
            catch (Exception exception)
            {
                ...
                throw new GameFrameworkException(
                    $"Can not parse data bytes with exception '{exception}'.", exception);
            }
        }
