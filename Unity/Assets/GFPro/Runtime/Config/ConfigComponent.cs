...
namespace GFPro
{
    ...
    /// 全局配置组件。
    /// </summary>
    public sealed partial class ConfigComponent : Entity, IConfigComponent, IAwake
    {
        ...
        public void Awake()
        {
            ...
            m_DataProvider.SetResourceManager(ResourceComponent.Instance);
        }
        ...
        public bool GetBool(string configName)
        {
            ...
            {
                throw new GameFrameworkException($"Config name '{configName}' is not exist.");
            }
