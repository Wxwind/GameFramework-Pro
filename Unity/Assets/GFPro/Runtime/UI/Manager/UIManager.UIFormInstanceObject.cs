...
namespace GFPro.UI
{
    internal sealed partial class UIManager
    {
        ...
        {
            private UnityEngine.Object m_UIFormAsset;
            ...
            public static UIFormInstanceObject Create(string name, UnityEngine.Object uiFormAsset, object uiFormInstance, IUIFormHelper uiFormHelper)
            {
                if (uiFormAsset == null)
                {
