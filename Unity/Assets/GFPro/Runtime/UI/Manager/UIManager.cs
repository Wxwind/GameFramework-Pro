    ...
    internal sealed partial class UIManager : IUIManager
    {
            ...
            bool pauseCoveredUIForm, object userData = null)
        {
            ...
            if (uiFormInstanceObject == null)
            {
                ...
                try
                {
                    var asset = await m_ResourceComponent.LoadAssetAsync<UnityEngine.Object>(uiFormAssetName);
        ...
        public void CloseUIForm(int serialId)
        {
            ...
            if (uiForm == null)
            {
                throw new GameFrameworkException($"Can not find UI form '{serialId}'.");
            }
        ...
        private IUIForm LoadAssetSuccessCallback(string uiFormAssetName, UnityEngine.Object uiFormAsset,
            ...
            OpenUIFormInfo openUIFormInfo)
        {
            ...
            m_UIFormsBeingLoaded.Remove(openUIFormInfo.SerialId);
            var appendErrorMessage = $"Load UI form failure, asset name '{uiFormAssetName}', error message '{errorMessage}'.";
