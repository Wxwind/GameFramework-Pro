...
namespace GFPro
{
    ...
    public sealed unsafe partial class Kcp : IDisposable
    {
        ...
        public int Send(byte* buffer, int length)
        {
            return ikcp_send(_kcp, buffer, length);
        }
        ...
        public int Send(byte* buffer, int offset, int length)
        {
            return ikcp_send(_kcp, buffer + offset, length);
        }
        ...
        public int Input(byte* buffer, int length)
        {
            return ikcp_input(_kcp, buffer, length);
        }
        ...
        public int Input(byte* buffer, int offset, int length)
        {
            return ikcp_input(_kcp, buffer + offset, length);
        }
        ...
        public int Receive(byte* buffer, int length)
        {
            return ikcp_recv(_kcp, buffer, length);
        }
        ...
        public int Receive(byte* buffer, int offset, int length)
        {
            return ikcp_recv(_kcp, buffer + offset, length);
        }
        ...
        {
            ikcp_update(_kcp, current, _output, _buffer);
        }
        ...
        public void Flush()
        {
            ikcp_flush(_kcp, _output, _buffer);
        }
        ...
        {
            return ikcp_setmtu(_kcp, mtu, ref _buffer);
        }
        ...
        {
            ikcp_fastresendlimit(_kcp, fastlimit);
        }
