    ...
    internal sealed partial class EntityManager : GameFrameworkModule, IEntityManager
    {
        ...
        private sealed class EntityGroup : IEntityGroup
        {
            ...
            public EntityGroup(string name, float instanceAutoReleaseInterval, int instanceCapacity, float instanceExpireTime, int instancePriority,
                IEntityGroupHelper entityGroupHelper, IObjectPoolManager objectPoolManager)
            {
                ...
                m_InstancePool = objectPoolManager.CreateSingleSpawnObjectPool<EntityInstanceObject>(Utility.Text.Format("Entity Instance Pool ({0})", name), instanceCapacity,
