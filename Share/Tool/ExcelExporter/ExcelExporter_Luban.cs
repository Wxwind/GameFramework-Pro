            ...
            public static void DoExport()
            {
                ...
                for (int i = 0; i < dirs.Length; i++)
                {
                    ...
                    for (int j = 0; j < genConfig.cmds.Count; j++)
                    {
                        ...
                        string cmd = s_LubanCommandHeaderTemplate + genConfig.cmds[j];
                        cmd = cmd
                        ...
                        if (match.Success)
                        {
                            ...
                            if (paths.Length > 1)
                            {
                                ...
                                for (int k = 1; k < paths.Length; k++) cmdInfo.copyCodePath.Add(paths[k]);
                            }
                        }
                        ...
                        if (match.Success)
                        {
                            ...
                            if (paths.Length > 1)
                            {
                                ...
                                for (int k = 1; k < paths.Length; k++) cmdInfo.copyDataPath.Add(paths[k]);
                            }
                        }
                ...
                if (!isCheck)
                    foreach (var cmdInfo in cmdInfos)
                    {
                        ...
                        if (cmdInfo.copyCodePath != null)
                            foreach (string copyPath in cmdInfo.copyCodePath)
                            {
                        ...
                        if (cmdInfo.copyDataPath != null)
                            foreach (string copyPath in cmdInfo.copyDataPath)
                            {
